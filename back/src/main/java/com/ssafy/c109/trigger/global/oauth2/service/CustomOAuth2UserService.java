package com.ssafy.c109.trigger.global.oauth2.service;
...
import com.ssafy.c109.trigger.global.oauth2.OAuthAttributes;
...
public class CustomOAuth2UserService implements OAuth2UserService<OAuth2UserRequest, OAuth2User> {
    ...
    private Member getUser(OAuthAttributes attributes, SocialType socialType) {
        Member findUser = userRepository.findBySocialTypeAndSocialId(socialType,
