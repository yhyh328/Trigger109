...
private:
    ...
    void ServerMoveInputActionTriggered_Implementation(const FInputActionValue& Value);

    bool ServerMoveInputActionTriggered_Validate(const FInputActionValue& Value);
